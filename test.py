...
t2 = Task("t2",[], ["B"], run=t2_run)
t3 = Task("t3",[], ["C"], run=t3_run)
t4 = Task("t4",[], ["D"], run=t4_run)
t5 = Task("t5",[], ["E"], run=t5_run)
t6 = Task("t6",[], ["F"], run=t6_run)
t7 = Task("t7",[], ["G"], run=t7_run)
...
try:
    ...
    if task_system.detTestRnd():
        print("Conclusion: c'est DÉTERMINISTE.")
    else:
        print("Conclusion: ce n'est PAS DÉTERMINISTE.")
